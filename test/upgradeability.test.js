...
describe("Upgradable Proxy Pattern", function () {
    ...
    describe("Proxy", function () {
        ...
        it("Should set y", async function () {
            ...
            //We are accidentaly overwritting owners address in proxy contract because of storage collistion
            expect(await this.proxy.owner()).to.eq("0x0000000000000000000000000000000000000005");
            // If an attacker passes its own address here he will take control of project
            // Check out SELECTOR CLASHING
        })
    })
